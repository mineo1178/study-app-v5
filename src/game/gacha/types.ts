...
export type GachaExchangeReward = { ticketType?: GachaTicketType; itemId?: string; quantity: number };
export type GachaExchangeDefinition = { id: string; name: string; description: string; fragmentCost: number; reward: GachaExchangeReward };
export type GachaExchange = { exchangeId: string; exchangeItemId: string; fragmentCost: number; reward: GachaExchangeReward; exchangedAt: number };
