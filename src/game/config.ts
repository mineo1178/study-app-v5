...
export const NOVA_STAGE_1 = { battleId: "nova-stage-1", rivalId: "nova", name: "NOVA Stage 1", requiredMembers: 4, requiredSongs: 4, requiredVenueId: "city-hall", stats: { vocal: 49, dance: 58, song: 48, character: 54 }, rewards: { winFans: 700, winPoints: 20, participationFans: 35, participationPoints: 3 } } as const;
